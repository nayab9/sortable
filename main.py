...
diskInput1 = IOManager("products.txt")
diskInput1.printFilename()
diskInput1.readFileOntoDisk("manufacturer")
...
diskList = ListingMaker("listings.txt", "")
diskList.createResultsListDisk()
...
#fileInput1.writeFileUsingRam(listingList.resultDict)
